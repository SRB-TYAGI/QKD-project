/* MOD2CONVERT.CPP - Routines converting between sparse and dense mod2 matrices.*/
...
)
{
  ...
  { printf("mod2sparse_to_dense: Dimension of result matrix is less than source\n");
    return;
  }
...
)
{
  ...
  { printf("mod2dense_to_sparse: Dimension of result matrix is less than source\n");
    return;
  }
