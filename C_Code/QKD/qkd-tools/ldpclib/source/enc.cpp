...
void ldpc_encoder::sparse_encode
( char *sblk,
  char *cblk
)
{
  ...
  { 
    return; /* Shouldn't occur, even if the parity check matrix has 
                redundant rows */
  }
...
void ldpc_encoder::dense_encode
( char *sblk,
  char *cblk,
  mod2dense *u,
  mod2dense *v
...
void ldpc_encoder::mixed_encode
( char *sblk,
  char *cblk,
  mod2dense *u,
  mod2dense *v
