...
#include <cstddef> // (Optional) if you're using size_t

void encode(std::vector<unsigned char>& input, std::vector<unsigned char>& output);
void decode(std::vector<unsigned char>& input, std::vector<unsigned char>& output);
